...
final List<Manga> mangaList = [
  ...
  const Manga(
      ...
      url: "https://imgcover.manga-chan.me/showfull_retina/uploads/posts/2014-02/thumbs/1392293364_i177955.jp"),
];
...
Widget listing() => Center(child: MangaList(mangaList: mangaList));
Widget reading() => Center(child: MangaList(mangaList: mangaRead));
